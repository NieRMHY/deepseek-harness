...
export class WorkspaceController extends TypertRemoteService {
  static inject = ['typert', 'workspaceRegistry', 'sessions', 'agents', 'sessionPersistence', 'sessionProjectionCache']
  ...
  /**
   * Show one archived Session again in its accounting slot.
  ...
  /**
   * Permanently delete one Session (log, projection, accounting, archive entry).
